# Documentation For Axon Framework - Multitenancy Extension.

This folder contains the docs related to the Multitenancy Extension for Axon Framework. The docs in this folder are written as part of the [AxonIQ Library](https://library.axoniq.io), and are [written in Ascii and built with Antora.](https://library.axoniq.io/contibution-guide/overview/platform.html)
