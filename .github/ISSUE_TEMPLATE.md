<!--
Thanks for taking the time to draft up an issue for Axon Framework' Multi-Tenancy Extension!
Prior to starting off, please read the following:

## Usage Questions

If you are having difficulty using Axon Framework' Multi-Tenancy Extension,
 please consider checking Axon's Reference Guide first if it answers your question: https://docs.axoniq.io/reference-guide/extensions/multitenancy
...
You can find all three of them [here](https://github.com/AxonFramework/extension-multitenancy/issues/new/choose). 
