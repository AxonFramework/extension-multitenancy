 ...
 * <ul>
 *     <li>{@link org.axonframework.extension.multitenancy.spring.data.jpa.TenantDataSourceProvider} -
 *         Interface for providing tenant-specific DataSources</li>
 *     <li>{@link org.axonframework.extension.multitenancy.spring.data.jpa.TenantEntityManagerFactoryBuilder} -
 *         Builder for creating tenant-specific EntityManagerFactories</li>
 *     <li>{@link org.axonframework.extension.multitenancy.spring.data.jpa.TenantRepositoryFactory} -
 ...
 * }</pre>
 *
 * @see org.axonframework.extension.multitenancy.core.configuration.MultiTenancyConfigurer
 */
